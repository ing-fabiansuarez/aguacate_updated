        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $this->renderSection('listproduct') ?>" href="<?= base_url() . route_to('view_list_of_products') ?>">
                            <i class="ni ni-pin-3 text-primary"></i>
                ...
                <!-- Heading -->
                <h6 class="navbar-heading p-0 text-muted">
                    <span class="docs-normal">OFERE</span>
                </h6>
                <!-- Nav items -->
                <ul class="navbar-nav">
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url() . route_to('view_main_products') ?>">
                            <i class="ni ni-pin-3 text-primary"></i>
