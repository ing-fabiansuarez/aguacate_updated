    ...
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url() . route_to('buy_products_shop') ?>" method="get">
                        <div class="row justify-content-center">
                            <div class="col-md-5" id="BotonBusqueda">
                                <input name="documento" type="text" class="form-control" placeholder="Digite el numero de documento" required>
